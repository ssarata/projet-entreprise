...
routes.post('/:variableId/:documentTemplateId', authenticateToken, controller.createTemplateVariable.bind(controller));routes.get('/',authenticateToken, controller.findAll.bind(controller));
